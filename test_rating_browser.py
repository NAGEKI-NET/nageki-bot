"""
独立测试脚本：渲染 Rating 浏览器截图并校验 base64 图片。
...
默认使用线上 NAGEKI-NET-NEXT 前端：
    https://next.nageki-net.com/render/ongeki-rating
"""
...
class MockApiClient:
    ...
    rating_render_url = os.getenv("NAGEKI_RATING_RENDER_URL", "https://next.nageki-net.com/render/ongeki-rating")
